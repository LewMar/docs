...
Jeśli chcesz dać użytkownikowi predefiniowany zestaw opcji, możesz użyć metody `choice`. Możesz ustawić indeks wartości domyślnej tablicy, która ma zostać zwrócona, jeśli nie wybrano żadnej opcji:
